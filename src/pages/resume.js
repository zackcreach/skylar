          ...
          <Transition show={this.state.in}>
            <div ref={node => (this.container = node)}>
              <Content>
                ...
                <div className={row}>
                  <p className={colFull}>
                    L.A. On-Camera Training Center – Jamison Haase – Los
                    Angeles, CA
                  </p>
                </div>
                <div className={row}>
                ...
                <div className={row}>
                  <p className={colFull}>
                    Sword Fights, Inc. – Stage Combat, Brian Danner – Los
                    Angeles, CA
                  </p>
                </div>
                <div className={row}>
                  <p className={colFull}>
                    Highwire Comedy Improv – Atlanta, GA
                  </p>
                </div>
                <div className={row}>
                  <p className={colFull}>
                    Village Theater Improv – Atlanta, GA
                  </p>
                </div>
                <div className={row}>
